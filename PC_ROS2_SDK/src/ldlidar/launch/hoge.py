...
def generate_launch_description():
    ...
    share_dir = get_package_share_directory('ldlidar')
    rviz_config_file = os.path.join(share_dir, 'config','ldlidar_cartographer.rviz')
    cartographer_config_dir = LaunchConfiguration('cartographer_config_dir', 
                                                    default=os.path.join(share_dir, 'config'))
    configuration_basename = LaunchConfiguration('configuration_basename', default='ldlidar_cartographer.lua')
